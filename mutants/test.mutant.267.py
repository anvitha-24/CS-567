...
class TestInstructor(unittest.TestCase):
    def setUp(self):
        ...
        self.student = Student(1, "John Doe")
        self.course = self.instructor.create_course(1, "Python Programming", "Introduction to Python")
        self.course.add_student(self.student)
...
class TestCourseAdvanced(unittest.TestCase):
    ...
    def test_nonexistent_student_progress_update(self):
        ...
        self.assertEqual(self.course.get_student_progress(self.student(2+1)), "Student not enrolled")
